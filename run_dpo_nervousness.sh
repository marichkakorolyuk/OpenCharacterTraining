#!/bin/bash
#
# DPO pipeline for nervousness constitution using gpt-5-nano via OpenRouter
...
export OPENROUTER_API_KEY="${OPENROUTER_API_KEY:-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}"
...
SAVE_PATH="${OCT_LORA_PATH:-/workspace/loras}/nervousness-distillation/$CONSTITUTION"
